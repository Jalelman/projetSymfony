...
return [
    ...
    'payment_success' => [['stripeSession'], ['_controller' => 'App\\Controller\\PaymentController::paymentSuccess'], [], [['variable', '/', '[^/]++', 'stripeSession', true], ['text', '/commande/valide']], [], [], []],
    'payment_fail' => [['stripeSession'], ['_controller' => 'App\\Controller\\PaymentController::paymentFail'], [], [['variable', '/', '[^/]++', 'stripeSession', true], ['text', '/commande/echec']], [], [], []],
